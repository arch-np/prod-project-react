...
describe('features/EditableProfileCard', () => {
    ...
    test('При отмене, значения должны обнуляться', async () => {
        ...
        await userEvent.type(
            screen.getByTestId('ProfileCard.InputFirstName'),
            'user',
        );
        await userEvent.type(
            screen.getByTestId('ProfileCard.InputLastName'),
            'user',
        );
        ...
        expect(screen.getByTestId('ProfileCard.InputLastName')).toHaveValue(
            'user',
        );
